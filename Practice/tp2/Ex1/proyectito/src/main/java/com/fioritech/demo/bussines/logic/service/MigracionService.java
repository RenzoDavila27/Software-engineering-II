...
public class MigracionService {
    ...
    public MigracionResultado migrarProveedores(MultipartFile archivo) {
        ...
        try (BufferedReader reader = new BufferedReader(
            ...
            if (resultado.getRegistrosProcesados() == 0) {
                resultado.agregarAdvertencia("El archivo no contenía registros para procesar");
            }
        } catch (IOException e) {
            throw new BusinessException("No se pudo leer el archivo de migración", e);
        }
