...
public class PromocionService {
    ...
    public Promocion modificarPromocion(Long id, Promocion cambios) {
        Promocion existente = obtenerPromocionActiva(id);
        ...
        existente.setTitulo(cambios.getTitulo().trim());
        existente.setContenido(cambios.getContenido().trim());
    ...
    public void eliminarPromocion(Long id) {
        ...
        promocionRepository.save(existente);
    }

    public Promocion buscarPromocionPorId(Long id) {
        return obtenerPromocionActiva(id);
    }

    public void enviarPromocion(Long id) {
        Promocion promocion = obtenerPromocionActiva(id);
    ...
    public void verificarAtributos(Promocion promocion) {
        if (promocion == null) {
    ...
    private Promocion obtenerPromocionActiva(Long id) {
    ...
    private int enviarCorreosAUsuarios(Promocion promocion) {
        ...
        String subject = promocion.getTitulo();
        correos.forEach(correo -> emailService.sendEmail(correo, subject, construirCuerpoPromocion(promocion)));
        return correos.size();
    }
    ...
    private String construirCuerpoPromocion(Promocion promocion) {
        return String.format(PROMOCION_EMAIL_TEMPLATE,
                promocion.getTitulo(),
