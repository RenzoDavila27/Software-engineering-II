...
public class BooksController {
    ...
    @GetMapping
    public String books(@RequestParam(name = "tipo", required = false) String tipo,
                        @RequestParam(name = "valor", required = false) String valor,
                        Model model) {
        StringBuilder errores = new StringBuilder();
        String tipoNormalizado = StringUtils.hasText(tipo) ? tipo.trim().toUpperCase() : null;
        String valorNormalizado = StringUtils.hasText(valor) ? valor.trim() : null;
        try {
            model.addAttribute("libros", libroService.listarLibros(tipoNormalizado, valorNormalizado));
        ...
        model.addAttribute("tiposBusqueda", com.books.demo.bussiness.domain.LibroBusquedaTipo.values());
        model.addAttribute("tipoSeleccionado", tipoNormalizado);
        model.addAttribute("valorFiltro", valorNormalizado);
        return "books";
    }
    ...
    private String prepararVistaDetalle(LibroDto libro, String mode, Model model) {
        ...
        model.addAttribute("tiposLibro", TipoLibro.values());
