...
public class StartupDataTester {
    ...
    private DemoTestContext runServiceLayerChecks() {
        try {
            ...
            Libro libroPrincipal = libroFactory.configurarTipo(
                    Libro.builder()
            ...
            Libro libroActualizacion = libroFactory.configurarTipo(
                    Libro.builder()
                            .id(libroPrincipal.getId())
                            .titulo("Spring Boot Avanzado (2da Edición)")
                            .genero("Tecnología")
                            .paginas(360)
                            .fecha(libroPrincipal.getFecha())
                            .persona(persona)
                            .autores(Set.of(autorActivo))
                            .eliminado(false),
                    TipoLibro.FISICO
            ...
            Libro libroTemporal = libroFactory.configurarTipo(
                    Libro.builder()
