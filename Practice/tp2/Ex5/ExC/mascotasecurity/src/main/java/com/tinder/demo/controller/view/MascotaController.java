...
public class MascotaController {
    ...
    public String listarMascotas(Model model, Authentication authentication) throws Exception{
    ...
    public String perfil(Model model, Long id, String accion) throws Exception{
    ...
    public String editarMascota(@RequestParam(required = false) Long id, @RequestParam String nombre, @RequestParam Tipo tipo, @RequestParam Sexo sexo, @RequestParam MultipartFile archivo, Model model, Authentication authentication) throws Exception{
    ...
    public String listarMascotasInactivas(Model model, Authentication authentication) throws Exception{
        try {
    ...
    private Usuario obtenerUsuarioAutenticado(Authentication authentication) throws ErrorServiceException {
        if (authentication == null || !authentication.isAuthenticated()) {
            return null;
        }
        return usuarioService.buscarUsuarioPorMail(authentication.getName());
    }
}
