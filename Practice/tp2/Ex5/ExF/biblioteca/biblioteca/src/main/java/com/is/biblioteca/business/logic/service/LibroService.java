...
import com.is.biblioteca.business.logic.service.strategy.BusquedaStrategy;
import com.is.biblioteca.business.persistence.repository.LibroRepository;
import com.is.biblioteca.business.logic.service.strategy.EstrategiaSelector;
import com.is.biblioteca.business.logic.service.facade.FachadaCrearLibro;
...
public class LibroService {
	...
	@Autowired
    private EstrategiaSelector estrategiaSelector;

	@Autowired
	private FachadaCrearLibro facade;
	...
	public void crearLibro(MultipartFile archivo, Long isbn, String titulo, Integer ejemplares, String idAutor,
		...
		try {
			...
			Libro libro = facade.validarFacade(archivo,isbn,titulo, ejemplares,idAutor,idEditorial);
	...
	public List<Libro> buscarPorCriterio(String tipo, String valor) throws ErrorServiceException{
        BusquedaStrategy estrategia = estrategiaSelector.getEstrategia(tipo);
