...
public interface LibroRepository extends JpaRepository<Libro, String>{
    ...
    public List<Libro> listarLibroPorAutor(@Param("id") String id);
     ...
     @Query("SELECT l FROM Libro l WHERE l.autor.nombre = :nombre AND l.eliminado = FALSE")
    public List<Libro> listarLibroPorAutor2(@Param("nombre") String nombre);

    @Query("SELECT l FROM Libro l WHERE l.titulo= :titulo AND l.eliminado = FALSE")
    public List<Libro> listarLibroPorTitulo(@Param("titulo") String id);
